...
estudantes = {'71403700443':["Mateus Batista Almeida","13/11/2006","999778632","mtb@gmail.com",True]}
gastos = {"1":["Pizza G", "45","71403700443","10/06/2026", True]}
contas = {"1":["Conta de Luz","180","30/06/2026","PENDENTE", True]}
...
if gastos:
    id_gasto = max(map(int, gastos.keys())) + 1
else:
    id_gasto = 1
...
if contas:
    id_contas = max(map(int, contas.keys())) + 1
else:
    id_contas = 1
            ...
            if opcao_e == 1:
                ...
                if not estudantes:
                    ...
                    for cpf, dados in estudantes.items():
                        ...
                        status = "ATIVO" if dados[4] else "DESATIVADO"
                ...
                if cpf_att_e in estudantes and estudantes[cpf_att_e][4]:
                    ...
                    if opcao_att == 1:
                        ...
                        if novo_cpf_e in estudantes and novo_cpf_e != cpf_att_e:
                            print("CPF já cadastrado!")
                            time.sleep(2)
                        else:
